...
- **~170 containerships (450,000 TEU)** confirmed trapped unable to exit Persian Gulf (Linerlytica data)
- **150+ tankers** anchored near Hormuz
...
- **Dubai Air Cargo (DXB):** Handles ~2.5M tonnes annually; disrupting time-sensitive flows (fresh produce, pharmaceuticals, perishables) — impact happening NOW
...
- **Effective global containership capacity reduction:** Estimated **10–15%** (trapped ships + Cape rerouting cycle time extension)

## War Risk Insurance — SEVERITY UPGRADED: P&I CLUBS WITHDRAWING
- **P&I club coverage withdrawals CONFIRMED with specific clubs:** Gard, Skuld, NorthStandard, London P&I, American Club — all issued cancellation notices **effective March 5, 2026**
- **~90% of global ocean tonnage effectively uninsurable in Gulf** as of March 5 — not elevated premiums; **operational impossibility** for Western operators
- **March 5 is the next hard-date catalyst** — watch for any reversal or extension announcements before that date
...
- **Re-engagement signal from BOTH P&I clubs AND Lloyd's** = key indicator that ceasefire is credible and durable
- **Next plausible catalyst for re-engagement:** Trump-Xi summit (March 31–April 2) if it produces a ceasefire framework signal

## Hormuz Transit Volume — CONFIRMED COLLAPSE
- **Hormuz transit down ~81%** from January baseline
- January average: 10.3M dwt/day → March 1 estimate: ~1M dwt/day
...
- **Resolution timing:** Near-term credible ceasefire now implausible; Trump-Xi summit (March 31–April 2) is first plausible diplomatic catalyst

## Iraq Storage Overflow — NEW COMPOUNDING FACTOR
- **Iraq production cut 1.5 mb/d confirmed (potentially doubling to 3 mb/d)** as land storage fills
- Mechanism: Hormuz insurance closure → Iraqi crude cannot be exported by Western-insured tankers → storage overflows → forced production shut-ins
- **Distinct from Hormuz closure:** This is physical production removal, not just export route disruption
- **Reservoir damage risk:** Extended shut-ins may cause permanent reservoir damage → slower recovery even after ceasefire
- Shadow fleet absorbing some Iraqi crude at distressed prices; insufficient to clear overflow at normal production rates
...
- **Track separately from Gulf war risk insurance:**
...
- Triggered by Iran regional war
- Cape of Good Hope rerouting resuming (+10–14 days, major fuel premium)
- Brief reopening (Dec 2025 — Maersk transit) fully reversed
- **Saudi Red Sea rerouting attempt FAILING:** Saudi EW pipeline → Yanbu → Red Sea option blocked by Houthis — confirmed no viable Saudi/Gulf crude bypass at meaningful volumes for Western-insured operators
- Houthi capability fully intact; will persist through Iran conflict

## Cape Rerouting — Capacity Reduction Effect
- Adding 10–14 days round trip = **permanent throughput reduction for duration**
- Each ship completes fewer total voyages per month → fleet effective capacity reduced ~10–15% system-wide
- Effect compounds with 170 trapped containerships already removed from productive capacity
- **Panama Canal surge pressure:** Rerouting from Red Sea AND some Gulf traffic creating demand spike; any drought-related restriction compounds severely
...
- Saudi EW pipeline to Yanbu → Red Sea also compromised (Houthi dual-chokepoint)
- **Simultaneous blockage = Gulf states cannot export oil/LNG/goods at normal volumes by any Western-insurable sea route**

## Jebel Ali — Global Transshipment Disruption
- 9th largest container port globally
- Primary transshipment point for: Asian-manufactured goods → Europe, East Africa, South Asia
- Paralysis means: goods in transit stuck; import pipelines to East Africa/South Asia interrupted
- **Most exposed downstream markets:** East Africa (critically reliant on Jebel Ali), South Asia, smaller Gulf states
- **Threshold:** If ships remain trapped past ~March 17 (2 weeks from crisis onset), late April/May retail shock in East Africa/South Asia becomes high-confidence

## Consumer Goods Supply Chain — 6–8 Week Retail Consequence
- 170 containerships (450,000 TEU) trapped → retail shelf impact emerging late April/May 2026
- **Category risk:** Electronics, textiles, machinery parts, consumer goods
- **Most exposed markets:** East Africa (double shock: goods + fuel), South Asia (Pakistan double shock), Europe (perishables immediate; electronics 6–8 weeks)
- Air cargo (DXB disruption): Perishables, pharmaceuticals, time-sensitive goods — impact happening NOW
- See: [consumer_goods_supply_chain.md](consumer_goods_supply_chain.md)

## Other Ongoing Disruptions

### Panama Canal
- 2024: Drought restrictions; 2025–2026 partially recovered
- **Under surge pressure from rerouting demand** — Red Sea AND some Gulf traffic creating demand spike
- Critical alternative; any drought-related restriction in 2026 compounds capacity crunch severely

### Shadow Fleet
- ~600+ vessels; carrying Russian, Iranian, Venezuelan oil
- Iranian shadow fleet absorbing some Gulf crude at distressed prices
- Russian shadow fleet: continues operating; not directly affected
- **Bifurcated market:** Shadow fleet buyers at discounted Gulf crude prices vs. Brent war premium for Western-accessible crudes
...
|---|---|---|
| Strait of Hormuz | ~20% global oil; ~20% LNG | 🔴 P&I CLUB WITHDRAWALS EFFECTIVE MARCH 5; transit down 81%; Iraqi crude adding to effective supply removal; bifurcated market forming |
| Bab el-Mandeb | ~6.2 mb/d; majority Asia-EU containers | 🔴 HOUTHI ATTACKS ACTIVE; Saudi rerouting attempt failing |
...
| Panama Canal | Pacific-Atlantic | 🟡 Recovering; under surge rerouting pressure — monitor closely |
| Malacca Strait | ~16 mb/d | 🟡 Low current risk |
