# Energy Supply Chains — Global Overview
**Status: 🔴 ACUTE CRISIS — Hormuz physically disrupted; Saudi refinery shuttered; Qatar LNG halted; TTF above curtailment threshold**
**As of: March 2, 2026**

## CRITICAL SITUATION SUMMARY
- **Strait of Hormuz:** IRGC declared closed; physically disrupting — 3 tankers damaged, ~150 ships stranded; U.S. Navy contesting
- **Saudi Arabia:** Largest domestic oil refinery **shuttered by drone strike** — physical production/refining impact confirmed
- **Qatar LNG:** Production HALTED — ~20% of global LNG supply offline; Qafco ammonia/urea also halted
- **Red Sea:** Houthi attacks resumed; Suez route compromised again
- **Saudi East-West pipeline:** Only partial Hormuz bypass; **compromised** — Red Sea also under attack
- **TTF:** Confirmed at €39.14/MWh (+21–25%) — above the 2021–2022 nitrogen curtailment threshold
- **Oil and gas prices:** Brent intraday high $82.37 (+13%); settled ~$78.43 (+7.6%)

## Oil Market — ACUTE DISRUPTION

### Chokepoint Status
| Chokepoint | Daily Flow | Status |
|---|---|---|
| Strait of Hormuz | ~20 mb/d (~20% global oil) | 🔴 PHYSICALLY DISRUPTED — 3 tankers damaged; 150 ships stranded |
| Bab el-Mandeb | ~6.2 mb/d | 🔴 HOUTHI ATTACKS RESUMED |
| Suez Canal | ~9% global oil | 🔴 AT RISK |
| Saudi EW Pipeline (bypass) | ~5 mb/d | 🔴 COMPROMISED — Yanbu on Red Sea side; Red Sea also under attack |
| Turkish Straits | Russian Black Sea oil | ⚠️ Secondary risk |
| Malacca Strait | ~16 mb/d | 🟡 Low current risk |

### Supply Disruptions
- **Saudi Arabia:** Largest domestic refinery shuttered by drone strike; Aramco production at direct risk
- **Iranian oil (~1.5–2 mb/d):** Exports disrupted by Hormuz closure + conflict atmosphere
- **UAE:** Infrastructure under attack; Abu Dhabi energy exports at risk
- **Kuwait/Bahrain/Qatar:** Under Iranian attack; airports struck (economic targeting doctrine)
- **Venezuela:** Still disrupted from U.S. intervention
- **Russian oil:** Shadow fleet continues; not directly affected; **benefiting from price spike**

### Potential Upside Supply
- U.S. shale: Can ramp but months lead time
- OPEC+ strategic reserves: Limited
- U.S. Strategic Petroleum Reserve (SPR): Available but finite
- IEA coordinated release: Likely to be triggered
...
- **Europe:** Emergency scenario confirmed; 2022-style energy crisis re-emerged
  ...
  - U.S. LNG terminals already at capacity; cannot immediately compensate
  - Spot LNG prices: severe spike confirmed
- **Japan/South Korea:** Major Qatar LNG customers; acute supply disruption
- **China:** Qatar LNG customer + losing Iranian oil via Hormuz; JKM spike simultaneously
- **Russian LNG:** EU 20th package targeting Arctic LNG; paradoxically may need to delay enforcement

## European Energy Emergency — CONFIRMED SCENARIO
- Qatar was Europe's #1 or #2 LNG supplier post-Russia pivot
- No alternative at this volume exists on short notice
- EU emergency energy measures expected imminently
- Options under consideration:
  - IEA coordinated strategic reserve release
  - Emergency demand reduction mandates
  - Potential pause on Russian LNG sanctions enforcement (politically toxic)
...
## Price Environment
- Oil: Brent intraday high $82.37 (+13%); settled ~$78.43 (+7.6%); pre-crisis EIA forecast was $58/bbl
- LNG (spot): TTF €39.14/MWh confirmed; extreme spike; JKM following
- Petrochemicals: Disrupted (Gulf production at risk; Saudi refinery shuttered)
...
- China emergency energy response (strategic reserves, Power of Siberia 2 acceleration)
- Whether Russia exploits crisis for sanctions relief leverage
