# Fertilizer & Agricultural Inputs — Supply Chain Risk
**Status: 🔴 ACTIVE SHOCK — Dual-channel disruption confirmed; historically unprecedented combination**
**As of: March 3, 2026**

## SITUATION — STRUCTURALLY WORSE THAN 2021
Two simultaneous disruption channels are now active:

### Channel 1: European Factory Curtailment (TTF-driven)
- TTF confirmed at **€39.14/MWh** — +21–25% from Friday close
- **Above the threshold that rendered European nitrogen production uneconomic in 2021–2022**
- Major European producers (Yara, OCI, BASF) facing curtailment economics now
- First curtailment announcements expected **this week** — watch press releases
- **Critical duration anchor:** Qatar LNG has a 3–6 week physical restart floor regardless of any ceasefire → TTF stays elevated through at minimum April → Channel 1 persists even in best-case Hormuz resolution scenario

### Channel 2: Direct Middle East Production Shutdown
- **Qatar (Qafco):** Ammonia AND urea exports halted alongside LNG — direct supply removal
- **Saudi Arabia (Ras Tanura area):** Ammonia/urea production at risk from Iranian strikes; refinery infrastructure shuttered
- **UAE:** Ammonia production at risk
- This channel was **absent in 2021**; it compounds the European curtailment channel
- Result: Global nitrogen supply being squeezed from both ends simultaneously

## The TTF → Fertilizer Transmission Mechanism
1. **TTF spike** confirmed (€39.14/MWh — above threshold) ✅
2. **European ammonia/urea production becomes uneconomic** — confirmed at current TTF ✅
3. **Major European producers curtail production** — announcement imminent (watch this week)
4. **Global nitrogen supply tightens** → Tampa ammonia benchmark rises (3–5 week lag)
...
- Contributed to 2022 global food price crisis alongside Black Sea disruption
- **2026 is structurally worse:** 2021 had only Channel 1; 2026 has BOTH channels simultaneously

## Key Producers to Watch
| Company | Country | Significance | Status |
|---|---|---|---|
| Yara | Norway/EU | World's largest nitrogen producer | ⚠️ Curtailment economics confirmed; announcement imminent |
| OCI | Netherlands/global | Major ammonia/urea producer | ⚠️ European operations at risk |
| BASF | Germany | Ludwigshafen highly gas-intensive | ⚠️ At curtailment threshold |
| Qafco | Qatar | Major global ammonia/urea exporter | 🔴 HALTED — direct shutdown |
| Saudi/UAE producers | Gulf | Significant ammonia exporters | 🔴 Under attack; production at risk |
| CF Industries | USA | Benefits from Henry Hub vs. TTF spread | 🟢 Relative winner |
| Koch Fertilizer | USA | Benefits from Henry Hub advantage | 🟢 Relative winner |
| Mosaic | USA | Potash/phosphate; earnings revisions likely | ⏳ Watch analyst estimate revisions |

## Key Benchmarks & Indicators
| Indicator | Current Signal | Lag | Status |
|---|---|---|---|
...
- Nitrogen application for corn concentrated February–April in U.S. Corn Belt
- Qatar LNG halt minimum 3–6 weeks → TTF elevated **at minimum through April** — worst-case overlap confirmed
- **Risk:** Fertilizer price spike hits at maximum sensitivity point for 2026 crop inputs
- Farmer response options: reduce application rates (yield drag), delay (agronomic risk), or absorb cost
- **USDA Prospective Plantings report (late March 2026):** CRITICAL MARKET-MOVING EVENT
  - Will capture whether farmers are reducing nitrogen application intentions
  - Will reveal crop switching (away from nitrogen-intensive corn toward soybeans)
  - Single most important agricultural data release in the next 4 weeks
  - Tampa benchmark data may not fully arrive before this report — watch for forward-looking farmer behavior signals
...
- ✅ Qatar LNG 3–6 week physical restart floor sustains TTF elevation through April regardless of Hormuz
- ✅ Simultaneous oil price spike increasing agricultural logistics costs
