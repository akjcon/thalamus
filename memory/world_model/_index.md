...
**⚠️ CRITICAL: Middle East regional war; IRGC naval assets eliminated; Hormuz insurance-enforced; P&I club withdrawals effective March 5; Saudi Red Sea bypass CONFIRMED FAILING — NO viable Gulf crude bypass at meaningful volumes; Iraq forced shut-ins (1.5–3 mb/d) with reservoir damage risk; bifurcated oil market forming; Fujairah bypass partially compromised; Ras Tanura refined products offline; 170 containerships trapped; 6–8 week consumer goods shock emerging; Operation Epic Fury named; U.S. war goals incoherence undermining ceasefire credibility; China two sessions urea export decision IMMINENT (days); Atlantic-basin VLCC route shift more durable than war risk premium; Ecuador U.S. Special Forces operations added**
...
- [energy_supply_chains.md](energy_supply_chains.md) — CRITICAL: Hormuz insurance-enforced; **Saudi Red Sea bypass FAILING**; **Iraq forced shut-ins (1.5–3 mb/d)**; Fujairah bypass partially compromised; Ras Tanura 550k b/d offline; Qatar LNG halted; TTF above curtailment threshold
- [global_shipping.md](global_shipping.md) — P&I clubs withdrawing effective March 5; 170 containerships (450k TEU) trapped; Jebel Ali paralyzed; **bifurcated tanker market forming**; **Atlantic-basin VLCC route shift more durable than war risk premium (FRO, NAT as proxies)**; dual chokepoint; 6–8 week retail consequence window
...
- [oil_gas_market.md](oil_gas_market.md) — 🔴 ACUTE CRISIS: Brent $81.40 (+12%); **Iraq shut-ins (1.5–3 mb/d) + reservoir damage risk**; **Saudi bypass FAILING**; **bifurcated market**; **Atlantic-basin VLCC route shift (FRO, NAT proxies)**; refined products + naphtha/petrochemical distinct shocks; crack spreads key
...
- [energy_supply_chains.md](energy_supply_chains.md) — CRITICAL: Hormuz insurance-enforced; Saudi bypass FAILING; Iraq shut-ins; Fujairah compromised; Ras Tanura offline; Qatar LNG halted
- [global_shipping.md](global_shipping.md) — P&I clubs withdrawing March 5; 170 containerships trapped; bifurcated tanker market; Atlantic-basin VLCC route shift (FRO, NAT)
- [oil_gas_market.md](oil_gas_market.md) — Brent $81.40; Iraq shut-ins; Saudi bypass failing; bifurcated market; Atlantic-basin route shift; refined products + naphtha shock
- [fertilizer_agricultural_inputs.md](fertilizer_agricultural_inputs.md) — Dual-channel nitrogen shock; spring planting risk; China two sessions urea decision IMMINENT
- [consumer_goods_supply_chain.md](consumer_goods_supply_chain.md) — 6–8 week retail shelf consequence

### Major Power Dynamics
- [us_foreign_policy_2026.md](us_foreign_policy_2026.md) — Operation Epic Fury named; war goals incoherence (Vance vs. Trump); 4–5 week timeline vs. establishment 'Pottery Barn' signal; Oman back-channel; Trump-Xi summit March 31–April 2
- [china_global_posture.md](china_global_posture.md) — Energy crisis; Power of Siberia 2 acceleration; Hormuz de-escalation incentive; **two sessions urea export decision IMMINENT (days)**; 3-month oil stockpile buffer; Trump-Xi summit
- [russia_global_posture.md](russia_global_posture.md) — Energy windfall; war economy; possible sanctions leverage attempt
- [europe_security_posture.md](europe_security_posture.md) — Energy emergency re-emerged; Qatar LNG crisis; RAF Akrotiri struck; NATO Article 5 live; possible Russian LNG sanctions pause

### Regional Overviews
- [middle_east_overview.md](middle_east_overview.md) — 🔴 ACTIVE REGIONAL WAR
- [africa_overview.md](africa_overview.md) — Sahel, Sudan, DRC, great power competition; East Africa double shock
- [asia_pacific_overview.md](asia_pacific_overview.md) — Taiwan Strait, South China Sea, Korea

### Commodities & Markets
- [oil_gas_market.md](oil_gas_market.md) — 🔴 ACUTE CRISIS: Brent $81.40 (+12%); Iraq shut-ins; Saudi bypass failing; bifurcated market; Atlantic-basin route shift; refined products + naphtha shock
- [food_agriculture_supply.md](food_agriculture_supply.md) — 2026 spring planting season risk
- [fertilizer_agricultural_inputs.md](fertilizer_agricultural_inputs.md) — 🔴 Dual-channel nitrogen shock; **China two sessions urea decision IMMINENT**
...
### U.S. Operations — New / Monitoring
- [ecuador_us_operations.md](ecuador_us_operations.md) — 🟡 U.S. Special Forces active; constitutional ban on permanent bases upheld; low current supply chain impact; monitor banana export infrastructure
